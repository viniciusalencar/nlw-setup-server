...
CREATE TABLE "new_habit_week_days" (
    ...
    CONSTRAINT "habit_week_days_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "hibits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "hibits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
